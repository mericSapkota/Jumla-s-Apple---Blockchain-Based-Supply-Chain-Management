const variants = {
  primary: "bg-primary text-on-primary shadow-[0_4px_12px_rgba(15,82,56,0.2)] hover:bg-primary-container",
  ...
  accent: "bg-role-accent text-on-secondary-fixed hover:opacity-90 shadow-md",
};
